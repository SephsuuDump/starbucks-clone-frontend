...
export function RecentOrders({ activeDateFilter, setDateFilter, activeInvoice, setInvoice, recentOrder }: Props) {
    return(
        <ScrollArea className="col-span-3 rounded-md shadow-sm bg-white p-3 h-[80vh]">
                    ...
                    >
                        <div className="w-full">
                            ...
                            <div className="flex gap-2">
                                <div className="w-20 ml-6 text-lg font-semibold">{ item.supplies.length } <span className="text-xs text-gray-500">items</span></div>
