...
import { SupplierItem } from "@/features/procurement/components/SupplierItem";
import { SupplierPurchasedOrders } from "@/features/procurement/components/SupplierPurchasedOrders";
...
export function SupplierPage() {
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                const userRes = await UserService.getUserBySupplier(claims.id);
